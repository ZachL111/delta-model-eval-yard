"""Regression checks for the delta-model-eval-yard casebook."""
...
from casebook.harness import assert_expected, delta_model_eval_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(delta_model_eval_yard_summary(), assert_expected())
